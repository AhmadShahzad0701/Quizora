        ...
        return (
          <div key={player.position} className="flex flex-col items-center relative">
            ...
            <div className={`z-20`}>
              ...
              {/* Timer (only for 1st place) */}
              {player.position === 1 && player.timeRemaining && (
                <div className="mt-4 flex flex-col items-center text-[#FFFFFF]/80">
                  <Timer className="h-5 w-5 mb-1" />
                  <p className="text-xs">Ends in</p>
                  <p className="font-semibold text-sm">{player.timeRemaining}</p>
                </div>
              )}
            </div>
          </div>
